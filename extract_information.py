...
def extract_pe_info(file_path):
    ...
    for entry in pe.DIRECTORY_ENTRY_IMPORT:
        ...
        for imp in entry.imports:
            countm += 1
    function_exp = []
    try: # to get the function exports in the exec files --> elle sert pour faire l'obsfuction analysis
...
def Extract_informations(file_path):
    print(file_path)
    dataset = {}
...
Extract_informations(r"./pestudio.exe")